; A "starter" assembly language game for the NES
;
...
; =============================================================================
; Common include files for NES development. These files are not specific to
; this project.
; =============================================================================
...
; =============================================================================
;  ROM Code.
;  NES games are driven by three interrupt service routines, from which other
;  procedures are called that are stored in seperate libraries (see the /lib
; project directory).
; =============================================================================
...
; =============================================================================
;  Interrupt Vector Table. Each of these three 16 (sixteen) bit addresses
; points to a procedure that is called automatically by the NES hardware.
; =============================================================================
